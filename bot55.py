...
BOT_TOKEN = '7403190402:AAFe8lnk3v_63_ih0bmoxIy63XV7YOixjls'
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text('Assalomu Alaykum! Thanks for your attention. Please, use the buttons below:', reply_markup=reply_markup)
